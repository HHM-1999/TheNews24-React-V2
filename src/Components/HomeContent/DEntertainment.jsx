                            ...
                            <div class="col-lg-8">
                                <div class="entertainment-lead-img">
                                    {entertainment.ImageBgPath ?
                                        <img src={process.env.REACT_APP_IMG_Path + entertainment.ImageBgPath} alt={entertainment.ContentHeading} title={entertainment.ContentHeading} className="img-fluid" /> :
                                        <img src={process.env.REACT_APP_LAZYL_IMG} alt={entertainment.ContentHeading} title={entertainment.ContentHeading} className="img-fluid" />}
